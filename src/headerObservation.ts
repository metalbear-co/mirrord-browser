...
export function rotateBuckets(obs: HeaderObservation, nowMs: number): HeaderObservation {
...
export function recordRequest(
  ...
  const recent = [{ url, method, at: nowMs }, ...rotated.recent].slice(0, RECENT_URL_LIMIT)
  return {
    ...rotated,
    buckets,
    recent,
...
export function setHeaderName(obs: HeaderObservation, headerName: string): HeaderObservation {
