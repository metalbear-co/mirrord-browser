export const STRINGS = {
  ...
  MSG_MIRRORD_UI_CONNECTED_HINT: 'You can close this tab and open the extension popup.',
  ...
  MSG_MISSING_CONFIG_HINT: 'Expected backend+token, or join parameter in the URL.',
  MSG_UI_NOT_CONFIGURED: 'mirrord ui not configured',
  MSG_UI_NOT_CONFIGURED_HINT: 'Run mirrord ui first and open the configure URL it prints.',
  ...
  ERR_KEY_NOT_VISIBLE: (key: string) => `Key "${key}" not visible in current session list`,

  SETTINGS_TITLE: 'Settings',
  SETTINGS_ANALYTICS_LABEL: 'Usage analytics',
  SETTINGS_ANALYTICS_DESCRIPTION: 'Help improve mirrord by sending anonymous usage data.',
...
export const METALBEAR_EXTENSION_URL = 'https://metalbear.com/mirrord/extension'
...
export type ConfigureStatusKind = (typeof CONFIGURE_STATUS)[keyof typeof CONFIGURE_STATUS]
