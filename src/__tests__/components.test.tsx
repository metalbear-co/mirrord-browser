...
describe('HeaderForm', () => {
  ...
  it('calls onHeaderNameChange when header name input changes', () => {
    ...
    render(<HeaderForm {...defaultProps} onHeaderNameChange={mockOnChange} />)
  ...
  it('calls onHeaderValueChange when header value input changes', () => {
    const mockOnChange = jest.fn()
    render(<HeaderForm {...defaultProps} onHeaderValueChange={mockOnChange} />)
  ...
  it('renders placeholder text for inputs', () => {
    ...
    expect(screen.getByPlaceholderText('X-MIRRORD-USER')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('testuser')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('Leave empty for all URLs')).toBeInTheDocument()
  })
