...
// popup can be driven. Everything else (parseRules, buildShareUrl, refreshIconIndicator)
// stays real and uses the shared browser mock from jest.setup.ts.
...
describe('Popup', () => {
    ...
    it('resets to defaults when reset button is clicked', async () => {
        ...
        await waitFor(() => {
            expect(mockStorageRemove).toHaveBeenCalledWith(['override']);
        });
    });
